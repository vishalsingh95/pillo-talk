...
<div class="col-md-12" ><a href="add_category.php" style='float:right' class='btn btn-primary'>Add Category</a></div>
...
$sno=1;
    ...
    ?><tr>
        ...
        <td><a  href="edit_category.php?id=<?php echo $ctegy_id;?>" class='btn btn-success'><i class='fa fa-edit'></i></a> <a href="delete_category.php?id=<?php echo $ctegy_id;?>" onclick="return confirm('Are you sure want to delete this category?')"  class='btn btn-danger'><i class='fa fa-trash'></i></a></td>
        </tr>
        <?php
    }
    ?>

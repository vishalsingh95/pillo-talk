...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Add New Category</li>
</ol>
<div class="container-fluid">
...
<input type="file" accept="image/*"  name="ctgy_image" class="form-control"  style="border: 2px solid grey!important;" > 
</div>

<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Category type <span style="color:red;">*</span></label>
<select name="ctgy_type" class="form-control"  style="border: 2px solid grey!important;" required> 
...
$cat_type=$_POST['ctgy_type'];


$clt_dplc="select * from `product_category` where `name`='$categ_neme'";
...
$ad_prdt="insert into `product_category` set
name='$categ_neme',
image='$filename6',
type='$cat_type'";

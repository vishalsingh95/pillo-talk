...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">All Contact-us</li>
</ol>
...
<th style="border-bottom:2px solid black !important;">Message</th>
...
$sno=1;
    while($clct_usr_lst=$qst_usr_lst->fetch_assoc())
    {
        ...
        $msg=$clct_usr_lst['message'];
       $dete=$clct_usr_lst['date'];

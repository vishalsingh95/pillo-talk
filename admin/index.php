...
$clt_pend_count="select count(`id`) as `pending_order_count` from `orders` where `status`='Ordered'";
$qst_clt_pend_count=$db->query($clt_pend_count);
$clct_clt_pend_count=$qst_clt_pend_count->fetch_assoc();


$pending_order_count=$clct_clt_pend_count['pending_order_count'];
...
<div class="dbox__body" style="background: linear-gradient(23deg,#080909,#5d656e);border-radius: 12px;"><span class="dbox__count"><?php echo $ctgy_count;?></span> 
...
<div class="col-md-3 col-xs-6">
    <a href="view_pending_orders.php?ord_sts=Ordered" style="text-decoration:none">
<div class="dbox dbox--color-1" style="box-shadow: 5px 6px 20px 0px #8f8b8b;border-radius: 12px !important;">

<div class="dbox__body" style="background: linear-gradient(45deg,#fae664db,#ffe045b8);border-radius: 12px;"><span class="dbox__count"><?php echo $pending_order_count;?></span> 

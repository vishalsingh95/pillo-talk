...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">All Users</li>
</ol>
...
<th style="border-bottom:2px solid black !important;">Orders</th>
...
$sno=1;
    ...
    {
        $neme=$clct_usr_lst['name'];
        $emnl=$clct_usr_lst['email'];
        $mnbl=$clct_usr_lst['mobile'];
        $pswd=$clct_usr_lst['without_md5_pwd'];
        $usr_id=$clct_usr_lst['id'];
    ...
    ?><tr>
        ...
        <td><?php echo $mnbl;?></td>
        <td><?php echo $pswd;?></td>
        <td><a href="view_user_orders.php?id=<?php echo $usr_id;?>" class='btn btn-warning'><i class='fa fa-shopping-cart'></i></a></td>
        </tr>
        <?php
    }
    ?>
